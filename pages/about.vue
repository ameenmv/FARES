<template>
  <div class="pt-28">
    ...
    <!-- Services — interactive accordion rows -->
    <section class="container mx-auto px-6 lg:px-12 py-24 border-t border-zinc-200">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 mb-16">
        ...
        <div class="lg:col-span-8">
          <p ref="servicesDescRef" class="text-lg text-zinc-500 leading-relaxed" style="opacity: 0">
      ...
      <div class="space-y-0">
        ...
        >
          ...
          <!-- Expandable content -->
          <div
            :ref="(el) => { if (el) serviceContentRefs[index] = el as HTMLElement }"
            class="overflow-hidden"
            :style="{ height: activeService === index ? 'auto' : '0px' }"
          >
...
const servicesDescRef = ref<HTMLElement>()
...
onMounted(() => {
  ...
  nextTick(() => {
    ...
    if (servicesDescRef.value) {
      gsap.to(servicesDescRef.value, {
        opacity: 1, duration: 0.7, ease: 'power3.out',
        scrollTrigger: { trigger: servicesDescRef.value, start: 'top 90%', toggleActions: 'play none none none' },
      })
    }
